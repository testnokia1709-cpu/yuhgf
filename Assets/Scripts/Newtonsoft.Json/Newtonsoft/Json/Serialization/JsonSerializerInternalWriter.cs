...
namespace Newtonsoft.Json.Serialization
{
	internal class JsonSerializerInternalWriter : JsonSerializerInternalBase
	{
			...
			if (!property.Ignored && property.Readable && ShouldSerialize(writer, property, value) && IsSpecified(writer, property, value))
			{
				...
				if (ShouldWriteProperty(memberValue, property))
				{
					...
					if (memberValue == null)
					{
						...
						switch (property._required ?? ((jsonObjectContract != null) ? jsonObjectContract.ItemRequired : ((Required?)null)) ?? Required.Default)
						{
		...
		{
			TypeNameHandling value = ((member != null) ? member.TypeNameHandling : ((TypeNameHandling?)null)) ?? ((containerProperty != null) ? containerProperty.ItemTypeNameHandling : ((TypeNameHandling?)null)) ?? ((containerContract != null) ? containerContract.ItemTypeNameHandling : ((TypeNameHandling?)null)) ?? Serializer._typeNameHandling;
