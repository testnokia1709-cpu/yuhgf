...
namespace Newtonsoft.Json.Serialization
{
	public class DefaultContractResolver : IContractResolver
	{
		...
		private static readonly JsonConverter[] BuiltInConverters = new JsonConverter[3]
		{
			new BinaryConverter(),
		...
		private void SetPropertySettingsFromAttributes(JsonProperty property, object attributeProvider, string name, Type declaringType, MemberSerialization memberSerialization, out bool allowNonPublicAccess)
		{
			...
			NamingStrategy namingStrategy = ((((attribute != null) ? attribute.NamingStrategyType : null) != null) ? JsonTypeReflector.CreateNamingStrategyInstance(attribute.NamingStrategyType, attribute.NamingStrategyParameters) : ((((attribute3 != null) ? attribute3.NamingStrategyType : null) == null) ? NamingStrategy : JsonTypeReflector.GetContainerNamingStrategy(attribute3)));
			...
			property.NullValueHandling = ((attribute != null) ? attribute._nullValueHandling : ((NullValueHandling?)null));
			property.ReferenceLoopHandling = ((attribute != null) ? attribute._referenceLoopHandling : ((ReferenceLoopHandling?)null));
			property.ObjectCreationHandling = ((attribute != null) ? attribute._objectCreationHandling : ((ObjectCreationHandling?)null));
			property.TypeNameHandling = ((attribute != null) ? attribute._typeNameHandling : ((TypeNameHandling?)null));
			property.IsReference = ((attribute != null) ? attribute._isReference : ((bool?)null));
			property.ItemIsReference = ((attribute != null) ? attribute._itemIsReference : ((bool?)null));
			...
			property.ItemReferenceLoopHandling = ((attribute != null) ? attribute._itemReferenceLoopHandling : ((ReferenceLoopHandling?)null));
			property.ItemTypeNameHandling = ((attribute != null) ? attribute._itemTypeNameHandling : ((TypeNameHandling?)null));
