...
namespace ThirdParty.iOS4Unity
{
	public class UIApplication : NSObject
	{
		...
		public static UIApplication SharedApplication
		{
			get
			{
				return Runtime.GetNSObject<UIApplication>(ObjC.MessageSendIntPtr(_classHandle, Selector.GetHandle("sharedApplication")));
			}
		}
		...
		public UIWindow KeyWindow
		{
			get
			{
				return Runtime.GetNSObject<UIWindow>(ObjC.MessageSendIntPtr(Handle, Selector.GetHandle("keyWindow")));
			}
		}
		...
		public UIWindow[] Windows
		{
			get
			{
				return ObjC.FromNSArray<UIWindow>(ObjC.MessageSendIntPtr(Handle, Selector.GetHandle("windows")));
			}
		}
		...
		public UIApplicationState ApplicationState
		{
			get
			{
				return (UIApplicationState)ObjC.MessageSendInt(Handle, Selector.GetHandle("applicationState"));
			}
		}
