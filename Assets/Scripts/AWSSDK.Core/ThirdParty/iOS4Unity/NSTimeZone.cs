...
namespace ThirdParty.iOS4Unity
{
	public class NSTimeZone : NSObject
	{
		...
		public static string[] KnownTimeZoneNames
		{
			get
			{
				return ObjC.FromNSArray(ObjC.MessageSendIntPtr(_classHandle, Selector.GetHandle("knownTimeZoneNames")));
			}
		}
		...
		public static NSDictionary Abbreviations
		{
			get
			{
				return Runtime.GetNSObject<NSDictionary>(ObjC.MessageSendIntPtr(_classHandle, Selector.GetHandle("abbreviationDictionary")));
			}
		}
		...
		public NSData Data
		{
			get
			{
				return Runtime.GetNSObject<NSData>(ObjC.MessageSendIntPtr(Handle, Selector.GetHandle("data")));
			}
		}
		...
		public static string DataVersion
		{
			get
			{
				return ObjC.MessageSendString(_classHandle, Selector.GetHandle("timeZoneDataVersion"));
			}
		}
		...
		public int GetSecondsFromGMT
		{
			get
			{
				return ObjC.MessageSendInt(Handle, Selector.GetHandle("secondsFromGMT"));
			}
		}
		...
		public static NSTimeZone LocalTimeZone
		{
			get
			{
				return Runtime.GetNSObject<NSTimeZone>(ObjC.MessageSendIntPtr(_classHandle, Selector.GetHandle("localTimeZone")));
			}
		}
		...
		public static NSTimeZone SystemTimeZone
		{
			get
			{
				return Runtime.GetNSObject<NSTimeZone>(ObjC.MessageSendIntPtr(_classHandle, Selector.GetHandle("systemTimeZone")));
			}
		}
