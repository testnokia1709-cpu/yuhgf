...
namespace ThirdParty.iOS4Unity
{
	public class AdBannerView : UIView
	{
		...
		public AdType AdType
		{
			get
			{
				return (AdType)ObjC.MessageSendInt(Handle, Selector.GetHandle("adType"));
			}
		}
		...
		public bool BannerLoaded
		{
			get
			{
				return ObjC.MessageSendBool(Handle, Selector.GetHandle("isBannerLoaded"));
			}
		}
		...
		public event EventHandler<NSErrorEventArgs> FailedToReceiveAd
		{
			...
			remove
			{
				...
				if (_failedToReceiveAd != null && _failedToReceiveAd.TryGetValue(value, out value2))
				{
