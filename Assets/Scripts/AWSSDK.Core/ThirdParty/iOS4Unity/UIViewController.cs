...
namespace ThirdParty.iOS4Unity
{
	public class UIViewController : NSObject
	{
		...
		public bool IsViewLoaded
		{
			get
			{
				return ObjC.MessageSendBool(Handle, Selector.GetHandle("isViewLoaded"));
			}
		}
		...
		public UIViewController ParentViewController
		{
			get
			{
				return Runtime.GetNSObject<UIViewController>(ObjC.MessageSendIntPtr(Handle, Selector.GetHandle("parentViewController")));
			}
		}
		...
		public UIViewController PresentedViewController
		{
			get
			{
				return Runtime.GetNSObject<UIViewController>(ObjC.MessageSendIntPtr(Handle, Selector.GetHandle("presentedViewController")));
			}
		}
		...
		public UIViewController PresentingViewController
		{
			get
			{
				return Runtime.GetNSObject<UIViewController>(ObjC.MessageSendIntPtr(Handle, Selector.GetHandle("presentingViewController")));
			}
		}
