...
namespace ThirdParty.iOS4Unity
{
	public class UIScreen : NSObject
	{
		...
		public CGRect ApplicationFrame
		{
			get
			{
				return ObjC.MessageSendCGRect(Handle, Selector.GetHandle("applicationFrame"));
			}
		}
		...
		public UIScreenMode[] AvailableModes
		{
			get
			{
				return ObjC.FromNSArray<UIScreenMode>(ObjC.MessageSendIntPtr(Handle, Selector.GetHandle("availableModes")));
			}
		}
		...
		public static UIScreen MainScreen
		{
			get
			{
				return Runtime.GetNSObject<UIScreen>(ObjC.MessageSendIntPtr(_classHandle, Selector.GetHandle("mainScreen")));
			}
		}
		...
		public UIScreen MirroredScreen
		{
			get
			{
				return Runtime.GetNSObject<UIScreen>(ObjC.MessageSendIntPtr(Handle, Selector.GetHandle("mirroredScreen")));
			}
		}
		...
		public CGRect NativeBounds
		{
			get
			{
				return ObjC.MessageSendCGRect(Handle, Selector.GetHandle("nativeBounds"));
			}
		}
		...
		public float NativeScale
		{
			get
			{
				return ObjC.MessageSendFloat(Handle, Selector.GetHandle("nativeScale"));
			}
		}
		...
		public UIScreenMode PreferredMode
		{
			get
			{
				return Runtime.GetNSObject<UIScreenMode>(ObjC.MessageSendIntPtr(Handle, Selector.GetHandle("preferredMode")));
			}
		}
		...
		public float Scale
		{
			get
			{
				return ObjC.MessageSendFloat(Handle, Selector.GetHandle("scale"));
			}
		}
		...
		public static UIScreen[] Screens
		{
			get
			{
				return ObjC.FromNSArray<UIScreen>(ObjC.MessageSendIntPtr(_classHandle, Selector.GetHandle("screens")));
			}
		}
