...
namespace ThirdParty.iOS4Unity
{
	public class UIPopoverController : NSObject
	{
		...
		public UIPopoverArrowDirection PopoverArrowDirection
		{
			get
			{
				return (UIPopoverArrowDirection)ObjC.MessageSendUInt(Handle, Selector.GetHandle("popoverArrowDirection"));
			}
		}
		...
		public bool PopoverVisible
		{
			get
			{
				return ObjC.MessageSendBool(Handle, Selector.GetHandle("isPopoverVisible"));
			}
		}
