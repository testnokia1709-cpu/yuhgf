...
namespace ThirdParty.iOS4Unity
{
	public sealed class NSNotificationCenter : NSObject
	{
		...
		public static NSNotificationCenter DefaultCenter
		{
			get
			{
				return Runtime.GetNSObject<NSNotificationCenter>(ObjC.MessageSendIntPtr(_classHandle, Selector.GetHandle("defaultCenter")));
			}
		}
		...
		public NSObject AddObserver(string name, Action<NSNotification> action, NSObject fromObject = null)
		{
			...
			ObjC.MessageSend(Handle, Selector.GetHandle("addObserver:selector:name:object:"), observer.Handle, Selector.GetHandle("__onNotification:"), name, (fromObject == null) ? IntPtr.Zero : fromObject.Handle);
			return observer;
		}
