...
namespace ThirdParty.iOS4Unity
{
	public class NSDictionary : NSObject
	{
		...
		public uint Count
		{
			get
			{
				return ObjC.MessageSendUInt(Handle, Selector.GetHandle("count"));
			}
		}
		...
		public string[] Keys
		{
			get
			{
				return ObjC.FromNSArray(Runtime.GetNSObject<NSObject>(ObjC.MessageSendIntPtr(Handle, Selector.GetHandle("allKeys"))).Handle);
			}
		}
		...
		public NSObject[] Values
		{
			get
			{
				return ObjC.FromNSArray<NSObject>(Runtime.GetNSObject<NSObject>(ObjC.MessageSendIntPtr(Handle, Selector.GetHandle("allValues"))).Handle);
			}
		}
