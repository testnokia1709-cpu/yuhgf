...
namespace ThirdParty.iOS4Unity
{
	public sealed class UIDevice : NSObject
	{
		...
		public static UIDevice CurrentDevice
		{
			get
			{
				return Runtime.GetNSObject<UIDevice>(ObjC.MessageSendIntPtr(_classHandle, Selector.GetHandle("currentDevice")));
			}
		}
		...
		public float BatteryLevel
		{
			get
			{
				return ObjC.MessageSendFloat(Handle, Selector.GetHandle("batteryLevel"));
			}
		}
		...
		public UIDeviceBatteryState BatteryState
		{
			get
			{
				return (UIDeviceBatteryState)ObjC.MessageSendInt(Handle, Selector.GetHandle("batteryState"));
			}
		}
		...
		public bool GeneratesDeviceOrientationNotifications
		{
			get
			{
				return ObjC.MessageSendBool(Handle, Selector.GetHandle("isGeneratingDeviceOrientationNotifications"));
			}
		}
		...
		public string LocalizedModel
		{
			get
			{
				return ObjC.MessageSendString(Handle, Selector.GetHandle("localizedModel"));
			}
		}
		...
		public string Model
		{
			get
			{
				return ObjC.FromNSString(ObjC.MessageSendIntPtr(Handle, Selector.GetHandle("model")));
			}
		}
		...
		public string Name
		{
			get
			{
				return ObjC.FromNSString(ObjC.MessageSendIntPtr(Handle, Selector.GetHandle("name")));
			}
		}
		...
		public UIDeviceOrientation Orientation
		{
			get
			{
				return (UIDeviceOrientation)ObjC.MessageSendInt(Handle, Selector.GetHandle("orientation"));
			}
		}
		...
		public bool ProximityState
		{
			get
			{
				return ObjC.MessageSendBool(Handle, Selector.GetHandle("proximityState"));
			}
		}
		...
		public string SystemName
		{
			get
			{
				return ObjC.FromNSString(ObjC.MessageSendIntPtr(Handle, Selector.GetHandle("systemName")));
			}
		}
		...
		public string SystemVersion
		{
			get
			{
				return ObjC.FromNSString(ObjC.MessageSendIntPtr(Handle, Selector.GetHandle("systemVersion")));
			}
		}
		...
		public UIUserInterfaceIdiom UserInterfaceIdiom
		{
			get
			{
				return (UIUserInterfaceIdiom)ObjC.MessageSendInt(Handle, Selector.GetHandle("userInterfaceIdiom"));
			}
		}
