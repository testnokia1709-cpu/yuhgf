...
namespace ThirdParty.iOS4Unity
{
	public class SKPaymentQueue : NSObject
	{
		...
		public static bool CanMakePayments
		{
			get
			{
				return ObjC.MessageSendBool(_classHandle, Selector.GetHandle("canMakePayments"));
			}
		}
		...
		public SKPaymentTransaction[] Transactions
		{
			get
			{
				return ObjC.FromNSArray<SKPaymentTransaction>(ObjC.MessageSendIntPtr(Handle, Selector.GetHandle("transactions")));
			}
		}
		...
		public static SKPaymentQueue DefaultQueue
		{
			get
			{
				return Runtime.GetNSObject<SKPaymentQueue>(ObjC.MessageSendIntPtr(_classHandle, Selector.GetHandle("defaultQueue")));
			}
		}
		...
		public event EventHandler<NSErrorEventArgs> RestoreFailed
		{
			...
			remove
			{
				IntPtrHandler2 value2;
				if (_restoreFailed != null && _restoreFailed.TryGetValue(value, out value2))
				{
		...
		public event EventHandler<SKPaymentTransactionEventArgs> UpdatedTransactions
		{
			...
			{
				IntPtrHandler2 value2;
				if (_updatedTransactions != null && _updatedTransactions.TryGetValue(value, out value2))
				{
