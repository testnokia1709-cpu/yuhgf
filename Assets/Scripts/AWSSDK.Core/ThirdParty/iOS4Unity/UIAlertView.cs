...
namespace ThirdParty.iOS4Unity
{
	public class UIAlertView : NSObject
	{
		...
		public int ButtonCount
		{
			get
			{
				return ObjC.MessageSendInt(Handle, Selector.GetHandle("numberOfButtons"));
			}
		}
		...
		public int FirstOtherButtonIndex
		{
			get
			{
				return ObjC.MessageSendInt(Handle, Selector.GetHandle("firstOtherButtonIndex"));
			}
		}
		...
		public bool Visible
		{
			get
			{
				return ObjC.MessageSendBool(Handle, Selector.GetHandle("isVisible"));
			}
		}
