...
namespace ThirdParty.iOS4Unity
{
	public class SKPaymentTransaction : NSObject
	{
		...
		public DateTime TransactionDate
		{
			get
			{
				return (DateTime)ObjC.MessageSendDate(Handle, Selector.GetHandle("transactionDate"));
			}
		}
		...
		public string TransactionIdentifier
		{
			get
			{
				return ObjC.MessageSendString(Handle, Selector.GetHandle("transactionIdentifier"));
			}
		}
