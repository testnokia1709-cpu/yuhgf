...
namespace ThirdParty.iOS4Unity
{
	public class UIView : NSObject
	{
		...
		public UIView[] Subviews
		{
			get
			{
				return ObjC.FromNSArray<UIView>(ObjC.MessageSendIntPtr(Handle, Selector.GetHandle("subviews")));
			}
		}
		...
		public UIView Superview
		{
			get
			{
				return Runtime.GetNSObject<UIView>(ObjC.MessageSendIntPtr(Handle, Selector.GetHandle("superview")));
			}
		}
		...
		public UIWindow Window
		{
			get
			{
				return Runtime.GetNSObject<UIWindow>(ObjC.MessageSendIntPtr(Handle, Selector.GetHandle("window")));
			}
		}
